...
namespace IIS.ILYA
{
    ...
    public class Анкеты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ILYA.КатегСотруд fОтносКатСотр;
        
        private IIS.ILYA.Стаж fКакойСтаж;
        
        private IIS.ILYA.Возраст fВозрастСотруд;
        
        private string fКоммент;
        
        private IIS.ILYA.Специалист fСпециалист;
        
        private IIS.ILYA.DetailArrayOfОценПричУвольн fОценПричУвольн;
        ...
        public virtual IIS.ILYA.Возраст ВозрастСотруд
        {
            get
            {
                ...
                IIS.ILYA.Возраст result = this.fВозрастСотруд;
        ...
        public virtual IIS.ILYA.Стаж КакойСтаж
        {
            get
            {
                ...
                IIS.ILYA.Стаж result = this.fКакойСтаж;
        ...
        public virtual IIS.ILYA.КатегСотруд ОтносКатСотр
        {
            get
            {
                ...
                IIS.ILYA.КатегСотруд result = this.fОтносКатСотр;
        ...
        [PropertyStorage(new string[] {
                "Специалист"})]
        public virtual IIS.ILYA.Специалист Специалист
        {
            get
            {
                ...
                IIS.ILYA.Специалист result = this.fСпециалист;
        ...
        public virtual IIS.ILYA.DetailArrayOfОценПричУвольн ОценПричУвольн
        {
            get
            {
                ...
                {
                    this.fОценПричУвольн = new IIS.ILYA.DetailArrayOfОценПричУвольн(this);
                }
                IIS.ILYA.DetailArrayOfОценПричУвольн result = this.fОценПричУвольн;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View АнкетыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АнкетыE", typeof(IIS.ILYA.Анкеты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View АнкетыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АнкетыL", typeof(IIS.ILYA.Анкеты));
                }
            }
        }
    }
