...
namespace IIS.ILYA
{
    ...
    public class ПричинУвольн : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ILYA.ОценПричУвольн fОценПричУвольн;
        
        private IIS.ILYA.DetailArrayOfРекомендац fРекомендации;
        ...
        [PropertyStorage(new string[] {
                "ОценПричУвольн"})]
        [NotNull()]
        public virtual IIS.ILYA.ОценПричУвольн ОценПричУвольн
        {
            get
            {
                ...
                IIS.ILYA.ОценПричУвольн result = this.fОценПричУвольн;
        ...
        public virtual IIS.ILYA.DetailArrayOfРекомендац Рекомендации
        {
            get
            {
                ...
                {
                    this.fРекомендации = new IIS.ILYA.DetailArrayOfРекомендац(this);
                }
                IIS.ILYA.DetailArrayOfРекомендац result = this.fРекомендации;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПричинУвольнE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинУвольнE", typeof(IIS.ILYA.ПричинУвольн));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПричинУвольнL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинУвольнL", typeof(IIS.ILYA.ПричинУвольн));
                }
            }
        }
    }
