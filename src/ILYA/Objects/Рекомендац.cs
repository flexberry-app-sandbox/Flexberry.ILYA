...
namespace IIS.ILYA
{
    ...
    public class Рекомендац : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ILYA.ПричинУвольн fПричинУвольн;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.ILYA.ПричинУвольн.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПричинУвольн"})]
        public virtual IIS.ILYA.ПричинУвольн ПричинУвольн
        {
            get
            {
                ...
                IIS.ILYA.ПричинУвольн result = this.fПричинУвольн;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РекомендацE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РекомендацE", typeof(IIS.ILYA.Рекомендац));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРекомендац : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.ILYA.DetailArrayOfРекомендац members)

        // *** End programmer edit section *** (IIS.ILYA.DetailArrayOfРекомендац members)
        ...
        /// </summary>
        public DetailArrayOfРекомендац(IIS.ILYA.ПричинУвольн fПричинУвольн) : 
                base(typeof(Рекомендац), ((ICSSoft.STORMNET.DataObject)(fПричинУвольн)))
        {
        }
        
        public IIS.ILYA.Рекомендац this[int index]
        {
            get
            {
                return ((IIS.ILYA.Рекомендац)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.ILYA.Рекомендац dataobject)
        {
